...
--
-- Host: localhost    Database: flowerbox
-- ------------------------------------------------------
...
INSERT INTO `meta` VALUES (1,'version','1');
...
--
-- Dumping data for table `wobs`
--

LOCK TABLES `wobs` WRITE;
/*!40000 ALTER TABLE `wobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `wobs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-08-11 22:07:46
